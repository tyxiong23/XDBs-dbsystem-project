...
class FileIndex:
    ...
    def insert(self, key, value: RID):
        ...
        #     new_root_father = InterNode(page=new_page_id_father, father=new_page_id_father, child_key_list=[],
        #                                    child_list=[],
        #                                    index_handler=self._handler)
        ...
        #     
        #     new_root_son = InterNode(page=self._handler.new_page(), father=new_page_id_father,
    ...
    def build_node(self, page_id):
        ...
        if node_type == 0:
            res: InterNode = self._build_node_type_0(page_id=page_id, data=page_data)
        elif node_type == 1:
